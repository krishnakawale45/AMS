...
<body>
		...
		<div class="wrapper-inner">
			<h3 class="logo text-center">
				<a class="navbar-brand" href="index.html">
					<i class="fa fa-plane" style="font-size:70px;color:gold"></i> FLYHIGH</a>
			</h3>
		</div>
	</div>
	<!-- //banner -->
	...
	<section class="banner-bottom-agile-w3ls">
		...
		<h3 class="tittle-w3ls text-center">Booking</h3>
		<p class="sub text-center">!!Book Your Flight Here!!</p>
					...
					<div class="row contact_left_grid">
						<div class="col-md-6 con-left">
							<div class="form-group">
								<label for="validationCustom01 my-2">Flight No.</label>
								<input class="form-control" type="text" name="Name" placeholder="Flight Number" required="">
							</div>
							<div class="form-group">
								<label for="validationCustom01 my-2">Source</label>
								<input class="form-control" type="text" name="Name" placeholder="Enter Source" required="">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label for="validationCustom01 my-2">Phone</label>
						...
						<div class="col-md-6 con-right">
							<div class="form-group">
								<label for="validationCustom01 my-2">Flight</label>
								<input class="form-control" type="text" name="Name" placeholder="Flight Name" required="">
							</div>
							<div class="form-group">
								<label for="validationCustom01 my-2">Destination</label>
								<input class="form-control" type="text" name="Name" placeholder="Destination" required="">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label for="validationCustom01 my-2">Date</label>
								<input class="form-control" type="text" name="Name" placeholder="Date" required="">
							</div>
